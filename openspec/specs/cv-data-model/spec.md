...
Defines the core TypeScript interfaces and bilingual data structures that represent the CV as presentation-independent data. Models include header, highlights, snapshot, metrics, about me, experience, education, courses, skills, and footer sections with full Spanish and English content.
