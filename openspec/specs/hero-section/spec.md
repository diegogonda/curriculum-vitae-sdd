...
Renders the page header with name, professional role, target role, profile photo, clickable contact links (tel/mailto/external), key achievement highlights, executive snapshot with keyword tags, and impact metrics with prominent numeric values.
